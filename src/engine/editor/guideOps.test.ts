...
import { guideAddLive, guideEndDrag, guideMoveLive, sanitizeGuides } from './guideOps'

function mkDoc(): Document {
  return {
    version: 2, width: 800, height: 600,
    root: { id: 'root', kind: 'group', children: [] } as unknown as Document['root'],
    channels: [],
  }
}
